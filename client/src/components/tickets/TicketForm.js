    ...
    render() {
        ...
        return (
            ...
            <form onSubmit={this.handleSubmit}>
                ...
                <select name="customer" className="form-control" id="customer" value={this.state.customer} onChange={this.handleChange}>
                ...
                <select name="department" className="form-control" id="department" value={this.state.department} onChange={this.handleDeptChange}>
                    <option>select</option>
                    {
                ...
                <select multiple={true} className="form-control" name="employee" id="employee" onChange={this.handleMultiSelect}>
                    <option>select</option>
                    {
                ...
                <textarea name="message" className="form-control" id="message" value={this.state.message} onChange={this.handleChange} />
                ...
                <br/>
                <input className="btn btn-primary" type="submit" value="add ticket" />
            </form>
            </div>
        )
    }
